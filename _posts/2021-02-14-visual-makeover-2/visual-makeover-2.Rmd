...
```{r, echo=FALSE, fig.align='center', fig.cap='Reshape survey response fields'}
...
```{r, echo=FALSE, fig.align='center', fig.cap='Convert response to integer 1 to 5'}
...
```{r, echo=FALSE, fig.align='center', fig.cap='Calculated Fields for number of records, mean, and confidence interval'}
...
```{r, echo=FALSE, fig.align='center', fig.cap='Displaying confidence interval as line'}
...
```{r, echo=FALSE, fig.align='center', fig.cap='Reverse X-axis and reference line'}
...
```{r, echo=FALSE, fig.align='center', fig.cap='Create label near the data point'}
...
```{r, echo=FALSE, fig.align='center', fig.cap='Final appearance for part 1'}
...
```{r, echo=FALSE, fig.align='center', fig.cap='Sync X-axis and hide'}
...
```{r, echo=FALSE, fig.align='center', fig.cap='Adjustment before publishing to Tableau Public'}
