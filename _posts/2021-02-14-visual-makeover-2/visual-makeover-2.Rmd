...
1. The visualisation is divided into 2 parts, each with its own dashboard to allow a quick overview of average response among different variables e.g. country, gender, age group, followed up by a more detailed information for each survey questions.
